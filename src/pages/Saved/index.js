        ...
        <Row className="justify-evenly w-[100%]">
          ...
          <Column className="font-urbanist items-center w-[79%]">
            ...
            <Column className="lg:mt-[29px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] w-[94%]">
              ...
              <Row className="items-center justify-between lg:mt-[19px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] rounded-radius14 w-[100%]">
                <Row className="items-center justify-between rounded-radius14 w-[44%]">
                  <Button
                  ...
                  <Button
                    className="flex items-center justify-center text-center w-[32%]"
                    leftIcon={
                      <Img
